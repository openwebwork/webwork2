...
$sel->type_ok("id=uname", $ENV{WW_TEST_UNAME} // "admin");
$sel->type_ok("id=pswd", $ENV{WW_TEST_PWD} // "admin");
$sel->click_ok("id=none");
$sel->wait_for_page_to_load_ok("30000");
$sel->click_ok("link=Add Course");
$sel->wait_for_page_to_load_ok("30000");
$sel->type_ok("name=add_courseID", "TestCourseX");
...
$sel->text_is("link=TestCourseX","TestCourseX");
$sel->click_ok("link=TestCourseX");
$sel->wait_for_page_to_load_ok("30000");
$sel->text_is("id=page-title", "TestCourseX");
ok(not $sel->is_element_present("css=#warnings"));
$sel->type_ok("id=uname", $ENV{WW_TEST_UNAME} // "admin");
$sel->type_ok("id=pswd", $ENV{WW_TEST_PWD} // "admin");
$sel->click_ok("id=none");
