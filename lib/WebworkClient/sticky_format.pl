...
<link rel="stylesheet" type="text/css" href="/webwork2_files/js/apps/Knowls/knowl.css"/>
...
<script type="text/javascript" src="/webwork2_files/js/apps/Knowls/knowl.js"></script>
