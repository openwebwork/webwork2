...
<link rel="stylesheet" type="text/css" href="/webwork2_files/js/apps/Knowl/knowlstyle.css"/>
...
<script type="text/javascript" src="/webwork2_files/js/apps/Knowl/knowl.js"></script>
