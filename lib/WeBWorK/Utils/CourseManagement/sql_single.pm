...
# $CVSHeader: webwork2/lib/WeBWorK/Utils/CourseManagement/sql_single.pm,v 1.12 2006/09/15 22:09:36 sh002i Exp $
# 
...
sub addCourseHelper {
	...
	foreach my $table (@tables) {
		...
		$usernames{$source} = $params{username};
		$passwords{$source} = $params{password};
