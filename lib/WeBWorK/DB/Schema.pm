...
# $CVSHeader: webwork2/lib/WeBWorK/DB/Schema.pm,v 1.10 2006/10/05 19:44:51 sh002i Exp $
# 
...
use Exception::Class (
	'WeBWorK::DB::Schema::Exception' => {},
	'WeBWorK::DB::Schema::Exception::RecordExists' => {
		isa => 'WeBWorK::DB::Schema::Exception',
	},
);
