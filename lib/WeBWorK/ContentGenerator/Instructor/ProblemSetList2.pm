...
sub create_handler {
	...
	return CGI::div({class => "ResultsWithError"}, $r->maketext("You entered an invalid character. Please use only alphanumeric characters, periods, underscores, commas, and hyphens.")) unless $newSetID =~ /^[-a-zA-Z0-9_.,]+$/;
