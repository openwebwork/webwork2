...
sub head {
  ...
  print qq!<script src="$webwork_htdocs_url/js/lib/vendor/jquery/jquery-1.7.2.min.js"></script>!;
  print qq!<script src="$webwork_htdocs_url/js/jquery-ui-1.9.0.custom/js/jquery-ui-1.9.0.custom.min.js"></script>!;
