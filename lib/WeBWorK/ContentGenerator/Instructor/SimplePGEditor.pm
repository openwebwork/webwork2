...
package WeBWorK::ContentGenerator::Instructor::SimplePGEditor;
use base qw(WeBWorK);
...
sub body {
	...
	my $template = HTML::Template->new(filename => $WeBWorK::Constants::WEBWORK_DIRECTORY . '/htdocs/html-templates/simple-pg-editor.html');  
