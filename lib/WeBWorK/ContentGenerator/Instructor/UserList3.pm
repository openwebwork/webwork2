...
sub head{
	...
	print "<link rel='stylesheet' type='text/css' href='$site_url/js/lib/vendor/jquery/jquery-ui-for-classlist3/css/ui-lightness/jquery-ui-1.8.21.custom.css' > </style>";
	return "";
}
...
sub output_JS{
	...
	my $site_url = $ce->{webworkURLs}->{htdocs};
	print qq!<script data-main="$site_url/js/apps/ClasslistManager/classlistManager" src="$site_url/js/lib/vendor/components/requirejs/require.js"></script>!;
