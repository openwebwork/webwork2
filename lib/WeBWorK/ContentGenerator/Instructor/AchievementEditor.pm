...
sub output_JS{
	...
	print CGI::start_script({src=>"$site_url/js/legacy/vendor/tabber.js"}), CGI::end_script();
	...
	print CGI::start_script({src=>"$site_url/js/apps/AchievementEditor/achievementeditor.js"}), CGI::end_script();
