...
# $CVSHeader: webwork2/lib/WeBWorK/ContentGenerator/Feedback.pm,v 1.37 2006/01/25 23:13:52 sh002i Exp $
# 
...
sub body {
	...
	if (defined $r->param("sendFeedback")) {
		...
		# get info about remote user (from &WeBWorK::Authen::write_log_entry)
		...
		my $remote_ident = $r->get_remote_logname() || "UNKNOWN";
		
		# print message
		print $MAIL
			wrap("", "", "This feedback message was automatically generated by the WeBWorK",
				"system at $systemURL, in response to a request from",
				"$remote_ident\@$remote_host:$remote_port."
			), "\n\n";
