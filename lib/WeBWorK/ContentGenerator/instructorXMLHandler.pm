...
sub environment {
	my $envir = {
		...
		CAPA_Graphics_URL=>'',
		CAPA_GraphicsDirectory =>'/webwork/CAPA/CAPA_Graphics/',
		CAPA_MCTools=>'/webwork/CAPA/CAPA_MCTools/',
		CAPA_Tools=>'/webwork/CAPA/CAPA_Tools/',
		cgiDirectory=>'Not defined',
		cgiURL => 'Not defined',
		classDirectory=> 'Not defined',
		courseName=>'Not defined',
		courseScriptsDirectory=>'/webwork/system/courseScripts/',
