...
### Note: this is a copy of WeBWorK::Authen to work in the Dancer environment. (changes pstaabp)

package Authen;

=head1 NAME

Authen - Check user identity, manage session keys.
...
## mod_perl doesn't work with Dancer

#use mod_perl;
#use constant MP2 =>  1; ( exists $ENV{MOD_PERL_API_VERSION} and $ENV{MOD_PERL_API_VERSION} >= 2 );
