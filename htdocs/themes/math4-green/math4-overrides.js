...
//    $('.webwork_logo a img').attr('src','/webwork2_files/images/webwork_transparent_logo_small.png');

/* This changes the MAA Logo on the top to a new image */
//    $('.maa_logo a img').attr('src','/webwork2_files/images/maa_logo_small.png');
    $('.maa_logo').remove();
    $('.webwork_logo').removeClass('span2').addClass('span6');
