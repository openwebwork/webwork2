...
// A closeable div for WeBWorK.  Mostly this is common functionality for the announcement and help panes. 

webwork.ui.CloseableDiv = Backbone.View.extend({
    	tagName: "div",
	className: "closeable",
        visible: false,
        border: "none",
        ...
        initialize: function () {
            _.bindAll(this,"render","closeDiv","setHTML","setVisible");
            if (this.options.border) this.border = this.options.border;
            if (this.options.background) this.background = this.options.background;
            
        },
        setHTML: function(helpStr) {
            $(".info",this.$el).html(helpStr);
            this.setVisible(true);
        },
        events: {
            "click button.close-div": "closeDiv"
        },
        closeDiv: function () {this.setVisible(false);},
        render: function ()
        {
            this.$el.html("<div class='info'></div><button class='close-div'>close</button>");
