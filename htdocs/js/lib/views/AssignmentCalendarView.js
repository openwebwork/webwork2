    ...
    var AssignmentCalendarView = CalendarView.extend({
    	...
    	renderDay: function (day){
    		...
    		this.problemSets.each(function(assign){
    			if(config.parseWWDate(assign.get("due_date")).isSame(day.model,"day")){
    				day.$el.append(self.createAssignInfoBar(assign,"assign assign-due"));
    			}
    			if(config.parseWWDate(assign.get("open_date")).isSame(day.model,"day")){
    				day.$el.append(self.createAssignInfoBar(assign,"assign assign-open"));
    			}
    			var reducedScoreDate = config.parseWWDate(assign.get("due_date")).subtract("minutes",self.reducedScoringMinutes);
